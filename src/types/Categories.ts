...
export const DEFAULT_CATEGORIES: {
...
}[] = [
  {
    ...
    subCategories: ["Water", "Electricity", "Internet", "Rent", "Gas", "Phone Bill", "House Help"],
  },
  {
    name: "Debt Financing",
    subCategories: ["Friendly Debt", "M-Shwari", "Fuliza", "KCB M-Pesa", "Bank Loan", "Loan App"],
  },
  {
    name: "Income",
  ...
  {
    name: "Shopping",
    subCategories: ["Clothes", "Shoes", "Supermarket", "Electronics", "House Items"],
  },
  {
    name: "Transport",
    subCategories: ["Fuel", "Cab", "Boda boda", "Matatu", "Parking", "Car Wash", "Tolls"],
  },
  {
    name: "Transfer",
